...
import com.example.filemanager.databinding.DetailsViewBinding
import com.example.filemanager.databinding.RenameFieldBinding
import com.example.filemanager.databinding.VideoMoreFeaturesBinding
import com.example.filemanager.databinding.VideoViewBinding
...
class VideoAdapter(private val context: Context, private var videoList: ArrayList<Video>, private var isFolder: Boolean = false)
    ...
    override fun onBindViewHolder(holder: MyHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        Glide.with(context)
            ...
            .apply(com.bumptech.glide.request.RequestOptions().placeholder(R.mipmap.ic_video_player).centerCrop())
            .into(holder.image)
